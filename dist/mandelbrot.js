 ...
 */
export function calculateMandelbrot(cx, cy, maxIterations = 100) {
    let x = 0;
    let y = 0;
    let iteration = 0;
 ...
 */
export function getColor(iteration, maxIterations, scheme = 'grayscale') {
 ...
 */
export function pixelToComplex(pixelX, pixelY, width, height, viewport) {
 ...
 */
export function complexToPixel(real, imaginary, width, height, viewport) {
 ...
 */
export function renderMandelbrot(width, height, viewport, options) {
 ...
 */
export function createZoomViewport(currentViewport, x1, y1, x2, y2, width, height) {
 ...
 */
export function panViewport(currentViewport, dx, dy, width, height) {
 ...
 * @returns New zoomed viewport
 */
export function zoomAtPoint(currentViewport, centerX, centerY, zoomFactor, width, height) {
