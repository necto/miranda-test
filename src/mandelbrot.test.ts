...
describe('getColor', () => {
  ...
  it('should return black for all schemes when in set', () => {
    const schemes: Array<'grayscale' | 'rainbow' | 'fire'> = ['grayscale', 'rainbow', 'fire'];
...
describe('pixelToComplex', () => {
  it('should convert top-left corner correctly', () => {
    const viewport: Viewport = { xMin: -2.5, xMax: 1, yMin: -1.5, yMax: 1.5 };
...
describe('renderMandelbrot', () => {
  it('should return ImageData with correct dimensions', () => {
    const viewport: Viewport = { xMin: -2.5, xMax: 1, yMin: -1.5, yMax: 1.5 };
    const options: RenderOptions = { maxIterations: 100, colorScheme: 'grayscale' };
  ...
  it('should produce data for all pixels', () => {
    const viewport: Viewport = { xMin: -2.5, xMax: 1, yMin: -1.5, yMax: 1.5 };
    const options: RenderOptions = { maxIterations: 50, colorScheme: 'fire' };
